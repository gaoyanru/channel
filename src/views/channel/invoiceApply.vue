<template>
  <div style="padding: 15px" class="invoice-apply">
    <h3 class="vheader">发票申请</h3>
    <div class="invoice-declare">
      ...
      <ul>
        ...
        <li style="padding-top: 5px">2、第二年1-3月份可申请上年发票，4月份及以后则不可申请。</li>
      </ul>
    </div>
    <div class="vsearch">
    ...
    <el-table :data="tableData" border header-align="left" style="width: 100%">
      <el-table-column prop="InvoiceId" label="发票申请编号" width="170"></el-table-column>
      ...
      <el-table-column prop="Amount" label="发票金额" width="110"></el-table-column>
      <!-- <el-table-column prop="Property" label="发票类型" :formatter="CategoryFormat"></el-table-column> -->
      <el-table-column prop="ApplyDate" label="申请时间" :formatter="StatusDate" width="120"></el-table-column>
      <el-table-column prop="Status" label="状态" :formatter="StatusFormat"></el-table-column>
      <el-table-column prop="AuditMsg" label="审批意见" width="110"></el-table-column>
  ...
  methods: {
    ...
    apply(row) {
      ...
      Dialog(ApplyDialog, {
        ...
        this.onSearch()
        // 清空选中发票
        this.$store.dispatch('updateInvoiceSelectRows', [])
      }, () => {
        // 清空选中发票
        this.$store.dispatch('updateInvoiceSelectRows', [])
      })
